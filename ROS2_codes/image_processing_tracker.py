...
class ImageProcessingNode(Node):
    ...
    def cameracallback(self, image_data):
        ...
        # this part is implemented above
        # # get image size
        # image_height,image_width,image_channels = image_np.shape  
        ...
        # hue spectrum for red color
        lower_red = np.array([170, 100, 100])   # 1st range of red - for bright tone - 2nd one would be 170-180
